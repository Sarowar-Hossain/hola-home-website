...
const PlaceCard = ({ Icon, title }) => {
    ...
    return (
        <div className="w-1/2 sm:w-1/2 md:w-1/3 lg:w-1/4 p-2 sm:p-4 flex-shrink-0 flex-col flex-wrap ">
            <div className="cursor-pointer p-6 border border-[#484C52] rounded-md flex flex-col items-center justify-center" style={{ borderColor: isSelected ? '#F9C900' : '#484C52', backgroundColor: isSelected ? '#FFF8DB' : '' }} onClick={handleCardClick}>
