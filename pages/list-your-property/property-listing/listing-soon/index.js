...
const index = () => {
    ...
    useEffect(() => {
        const redirectionTimeout = setTimeout(() => {
            router.push("/list-your-property/property-listing/listing-success");
        }, 2000);
    ...
    return (
        <div className="container mx-auto mt-20 lg:w-[60%] 2xl:w-[45%] px-4">
            <div className='px-2 sm:px-10'>
                <h1 className="sm:text-3xl text-xl text-[#484C52] sm:mb-2 mb-3">Your Property will be listed soon !!</h1>
                <h1 className='text-sm sm:text-sm text-[#848484] w-full sm:w-10/12'>Please wait for the admin to verify the property. Guests can start booking your place once verification is completed.</h1>
            </div>
